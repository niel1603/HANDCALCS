...
E = 200 * GPa
# Beam and column
F_y_beam_column = 344.738 * MPa
F_u_beam_column = 448.1594 * MPa
# Plate
F_y_plate = 344.738 * MPa
F_u_plate = 448.1594 * MPa
# Stiffener
F_y_stiffener = 344.738 * MPa
F_u_stiffener = 448.1594 * MPa
# Bolt
F_nt_bolt = 779.10788 * MPa
F_nv_bolt = 468.84368 * MPa

# Bolt pretension force
T_b = 453.71844 * kN # For grade A490 bolt according to AISC Specification Table J3.1
...
k_des = 35.052  * mm  # fillet distance (design)

# End plate
b_p = 228.6     * mm  # plate width
t_p = 22.225    * mm  # plate thickness

# Bolt
d_bolt   = 31.75   * mm  # bolt diameter
clearance = 3.175  * mm  # bolt clearance
d_hole   = (d_bolt + clearance)  # hole diameter

# Bolt configuration
g     = 146.05   * mm  # bolt gauge
...
# Stiffener
t_s  = 12.7    * mm  # stiffener thickness
L_st = 203.2   * mm  # stiffener length
h_st = 114.3   * mm  # stiffener height
...
# Substitution
print("Substitution:")
print(f"  {b_p} ≤ {b_bf} + max({t_p}, {25.4 * mm})")
