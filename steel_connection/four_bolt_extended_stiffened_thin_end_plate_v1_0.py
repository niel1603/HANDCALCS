...
slenderness_limit = 0.56 * sqrt(E / F_ys)
...
# Result
t_p_req = sqrt(M_u_eq / (gamma_r * theta_b * F_yp * Y_p))
...
Q_max1_part2 = sqrt(F_yp**2 - 3*(F_1_prime/(w1_prime*t_p))**2)
...
Q_max2_part2 = sqrt(F_yp**2 - 3*(F_2_prime/(w1_prime*t_p))**2)
